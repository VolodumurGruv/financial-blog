const mockData = [
	{
		...
		description:
			...
			"\r\n" +
			"Industrials and banks, two highly cyclical sectors, are marginally underperforming the border market since January 6, the date that marked a reversal of the Dollar’s downtrend. The Industrial Select Sector SPDR Fund (XLI) has underperformed the S&P 500 by almost 4 percentage points since January 6, while the SPDR S&P Bank ETF (KBE) has underperformed by less than a tenth of a percentage point. Since that date, the U.S. Dollar Index (DXY) is up 1.6%.\r\n" +
			"\r\n" +
	...
	},
	{
		...
		description:
			...
			"\n" +
			"Bitcoin’s BTCUSD, 1.64% momentum higher has driven it to a year-to-date gain of over 64%, compared with a rise of 2.8% for the Dow Jones Industrial Average DJIA, +0.09%, a 4.8% advance for the S&P 500 index SPX, +0.47% and fetching 9.4% rally for the Nasdaq Composite Index COMP, +0.50% thus far in 2021.\r\n" +
			"\r\n" +
		...
		expertComment:
			"Interesting how Etheruem value is in lockstep with all bitcoin moves; and if one has ethereum, one has to convert ethereum to bitcoin, to take in any gains. This has to stop and be regulated because ethereum is so linked, it cannot move on it's own merit. So it's just an investment facet of btc?  And you can't trade, spend ethereum without 1st converting to bitcoin- if btc is a valid tool of commerce, ethereum should also, thus would cause  its bubble to burst if not linked; or maybe it would skyrocket if not being linked? World is not ready, only in increments.",
	},
	{
		title:
		...
		description:
			...
			"\r\n" +
			"You wouldn’t be able to tell just from looking at the market last week. The Dow Jones Industrial Average, after all, rose 310.16 points, or 1%, to 31,458.40, while the S&P 500 advanced 1.2%, to 3934.83, and the Nasdaq Composite gained 1.7%. All three closed at record highs. What could be wrong with that?\r\n" +
			"\r\n" +
		...
		expertComment:
			"I think that sometime in the near future the tax crosshairs will be on the 1% because the promises that were made with Trump's tax cut didn't pan out prior to the pandemic. Baby boomers are starting to tap into Social Security and it's only going to get worse by the time it's my turn at the feeding trough. Someone is going to have to pick up the tab and hitting the middle class is the proverbial third rail. The gains the market is experiencing is happening in a very compressed timeline because today's highs shouldn't have happened for at least four years down the road. Look at the S&P trend over the 10 years prior to 2020 and compare it to the last 12 months. Something is weird about the market and I predict a major correction this year.\n" +
			"\n",
	},
	{
		...
		description:
			...
			"\n" +
			"Most Asian markets were closed for the Lunar New Year holiday, but the Nikkei 225 index and Australia’s S&P/ASX 200 both finished lower. The Stoxx Europe 600 index advanced 0.6%, while the German DAX gained 0.1%. Brent oil and U.S. crude prices each climbed about 2.1%.\n" +
			"\n" +
			"The news on the vaccine front has been mixed, as a new Covid-19 variant that originated in South Africa has spread to the U.S. West Coast. At the same time, though, President Joe Biden’s administration has arranged to purchase hundreds of millions more vaccine doses and will have enough to vaccinate 300 million Americans—the majority of the country—by the end of July.\n" +
			"\n" +
			...
			"\n" +
			"“The last thing that anyone wants to see is the increase in the new variant cases in the U.S., which could further adversely influence economic activity. If such an event ever occurs, it is very likely to trigger a sharp selloff for the S&P 500, and gold prices will move higher,” said Naeem Aslam, chief market analyst, to clients in a note.\n" +
			"\n" +
		...
		expertComment:
			"Oil is making a nice come back today.  Looks like WTI of $60/bl is on the trading block to potentially come down possibly today but definitely in the very near future.  What are the catalyst buoying higher oil prices?\n" +
			"\n" +
			"1) EO making it harder for domestic oil to explore & drill on federal lands\n" +
			"2) Anticipation of more regs on domestic oil \n" +
			"3) Anticipated higher demand coming with the reopening of the US & world economies in 2021\n" +
			"4) Falling domestic oil production\n" +
			"5) OPEC+ staying disciplined in manage increases in oil supplies\n" +
			"6) Oil companies cut in Cap/Ex spending for exploring & drilling for new oil reserves in the coming years\n" +
			"7) Oil companies shifting resources to renewable green energy to offset their carbon foot print\n" +
			"\n" +
			"What does this all add up? Lower domestic supplies, OPEC+ has the ability to set prices again, & investors that picked up oil stocks during big oil wealth destruction phase are being & will be rewarded in 2021 & probably the next 3+ years. Follow the data points.",
	},
	{
		title:
		...
		description:
			...
			"\n" +
			"The agency didn’t respond to a request for comment. About 91% of assets the investment board manages are the trust funds of the Wisconsin Retirement System, which totaled $129.8 billion at the end of 2020.\n" +
			"\n" +
			...
			"\r\n" +
			"Some GE bears eased off late last year, while other analysts remain skeptical. GE’s fourth-quarter report was notable for showing free-cash-flow growth and including upbeat financial forecasts.\r\n" +
			"\r\n" +
	...
	},
	{
		...
		description:
			"Apple’s search for an auto maker to join the tech giant’s project to build autonomous vehicles continues, following reports that discussions have dissolved with Nissan.\n" +
			"\n" +
			...
			"\r\n" +
			"Ives singled out Hyundai as the most likely choice, with Volkswagen Group —which also makes Audi and Porsche —as the next best bet. With Hyundai out, investors should keep an eye on the German giant. The analyst also floated Tesla and Ford as possible candidates.",
		imageUrl:
			"https://s.wsj.net/public/resources/images/ON-EH827_applec_M_20210215083117.jpg",
		expertComment:
			"Apple should just buy GM.  It will give them the fastest entry into the market, with a couple of dozen new EV's slated over the next few years (including the beautiful Lyriq and Hummer), and with one of the best automation technologies in its' Cruise division.  GM is still very reasonably priced.  Oh, and to top it all off, GM has the best CEO in the industry.",
	},
	{
		title:
			"Simon Property Group Tries to Turn the Corner on an Ugly Year for Malls",
		description:
			"Shopping malls are the ultimate reopening trade, a bet on the resilience of the American consumer after nearly a solid year of stay-at-home orders and retail shutdowns.\r\n" +
			"\r\n" +
			...
			"\r\n" +
			"Shares of Simon Property Group (ticker: SPG), the biggest U.S. mall operator, are down 21% over the last year compared with the S&P 500’s 16.6% one-year gain. And it’s still cheap compared with rival mall owners, according to Morgan Stanley, which upgraded it to Overweight and raised its price target on the stock to $125.\r\n" +
			"\r\n" +
			"“While retail faces accelerating secular changes, we see multiple drivers of earnings growth for SPG,” analyst Richard Hill said in a note on Thursday. His previous rating was Equalweight with a price target of $88.\r\n" +
			"\r\n" +
			...
			"\r\n" +
			"Several analysts have raised their price targets on Simon stock this week. BTIG’s James Sullivan, who also raised his target to $125, said he expects a “solid recovery” back to pre-Covid levels over the next two to three years.\r\n" +
			"\r\n" +
			...
			"\r\n" +
			"“One heck of a year,” Simon said on a conference call with analysts on Monday. “Let’s not repeat it in any stretch of our imagination.”",
		imageUrl: "https://images.barrons.com/im-298112",
		expertComment:
			"There is good and bad everything, including mall REITs.  SPG is coming back, and will be making more than ever with the Taubman purchase and also the very well spent money on the Forever21 etc retailers.  I  believe they announced they have already recovered 60% of their purchase price for those various stores plus did $3.5 B in online sales too.",
	},
	{
		title:
		...
		description:
			...
			"\r\n" +
			"“The obstacle that needs to be addressed is ensuring there are clean and/or efficient energy sources available for miners to tap into, especially during peak periods. With greater demand comes greater cost per KW, therefore incentivizing use of seldom-used coal or gas-fired plants that are falling out of favor from an environmental and economic perspective,” said  Jeremy Klingel of consulting firm PA Consulting.\r\n" +
			"\r\n" +
			"Much like electric vehicles, the crypto industry could be a new avenue for load growth across the power industry, he added.\r\n" +
			"\r\n" +
			"Conventional mining accounts for roughly 10% of global power consumption, compared to up to 0.5% for bitcoin mining, he said.",
	...
	},
	{
		...
		description:
			...
			"\n" +
			"The Piggly Wiggly shorts got crushed, much as Melvin Capital dropped 53% in January chiefly on its GameStop downside bets, but that wasn’t the whole story. While there were some big winners, there were also some other big losers—none bigger than Piggly Wiggly’s founder and president, Clarence Saunders.\n" +
			"\n" +
			"“After working a sensational squeeze on Piggly Wiggly,” Barron’s reported at the time, “the Memphis grocer found that his ‘victory’ had cost him about $3,000,000 and control of his company.” It also tarnished Saunders’ legacy.\n" +
			"\n" +
			...
			"\n" +
			"To fuel continued expansion, Saunders in November 1922 announced plans to sell 100,000 new shares in the company. That, combined with unrelated news of a Piggly Wiggly licensee filing for bankruptcy, “caused heavy selling” in the stock, according to Barron’s, knocking the share price down to $30 from $45. Then Merrill Lynch and other Wall Street firms attempted a “bear raid,” shorting Piggly Wiggly stock in a bet it would fall further.\n" +
			"\n" +
			"Saunders cast the issue as good versus evil, asking potential investors, “Shall good business flee? Shall it tremble with fear? Shall it be the loot of the speculator?” as quoted in Mike Freeman’s Clarence Saunders and the Founding of Piggly Wiggly: The Rise & Fall of a Memphis Maverick.\n" +
			"\n" +
			...
			"\n" +
			"There was a “wild scramble by the shorts to cover,” Barron’s wrote, yet there was less of that than had expected. The stock showed a “declining tendency” after the shorts had covered, and “the over-the-counter market for the stock gradually disappeared.” In the end, “Saunders and his associates” were left with “practically the entire issue of 200,000 shares on their hands—a large part of which had been accumulated at high prices” with “no market” to sell them.\n" +
			"\n" +
			"To Barron’s, Saunders had simply suffered “the customary fate of the Main Streeter who attempts to beat Wall Street.” Indeed, just three years earlier, a short-squeeze engineered by the owner of Stutz Motor Co. ended in bankruptcy for both.\n" +
			"\n" +
			...
			"\r\n" +
			"That isn’t quite of the same magnitude as the gains made by Roaring Kitty, the GameStop investor whose initial $53,000 stake reached a value of at least $48 million. But the reality that some players will turn a handsome profit even as others are ruined hasn’t changed over the years.\r\n" +
			"\r\n" +
			...
			"\r\n" +
			"As for Saunders, he went back to Tennessee, where “Memphis folk still have confidence” in him, as Barron’s reported at the time. But his various post–Piggle Wiggly ventures, including Keedoozle automat-style stores, met with middling success. He died in 1953, his hopes of becoming the Henry Ford of supermarkets undone by an ill-fated decision to take on Wall Street.\r\n" +
			"\r\n" +
			"We’ll see if GameStop investors fare any better.",
		imageUrl: "https://images.barrons.com/im-293914",
		expertComment:
			"You don't have to go back to 1923. There are many cases including Volkswagen in 2008. In October 2008, Volkswagen's shares more than quadrupled in two days, briefly becoming the biggest company in the world. After Volkswagen’s peak in the same month, shares fell 58% in four days, and a month later the stock was down 70% from its top and gave back almost all of its gains.",
	},
	{
		title:
			"Some Stocks Are Lagging, While the Dollar Is Rising. That’s a Buying Opportunity.",
		description:
			"Some economically-sensitive stocks have underperformed the broader market, while the U.S. dollar has risen. That combination makes some nervous about those stocks, but they needn’t worry.\r\n" +
			"\r\n" +
			"Industrials and banks, two highly cyclical sectors, are marginally underperforming the border market since January 6, the date that marked a reversal of the Dollar’s downtrend. The Industrial Select Sector SPDR Fund (XLI) has underperformed the S&P 500 by almost 4 percentage points since January 6, while the SPDR S&P Bank ETF (KBE) has underperformed by less than a tenth of a percentage point. Since that date, the U.S. Dollar Index (DXY) is up 1.6%.\r\n" +
		...
		expertComment:
			"Actually if one bothers to look at the DXY index, one could see, even without eye glasses, that the dollar index is at the Bottom of the toilet, 2 year bottom to be exact...So it’s not running anywhere. As for cyclicals, which is a terribly vague term, a lot of dilapidated names of last year staged a magnificent come back over the last few weeks: steels and other metal stocks have tripled, autos have doubled, so have hotel names like Hilton and Mariott. Boeing is not selling more planes, but it also doubled, so did Fedex, and so has the shut down Disney, and most truckers like Ryder. While left for dead because of the wrecking ball called Amazon, names like Limited , Tapestry, Kohl’s and Nordstrom’s have quadrupled in a few months ...\n" +
